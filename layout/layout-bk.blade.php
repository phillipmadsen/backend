                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <li>
                                    <a href="{{LaravelLocalization::getLocalizedURL($localeCode) }}" hreflang="{{$localeCode}}"><img alt="" src="{!! asset('/backend/img/flags/es.png') !!}">{{{ $properties['native'] }}}</a>
...
Problem 1
- caffeinated/menus v2.3 requires laravelcollective/html 5.1.*|5.2.* -> satisfiable by laravelcollective/html[5.1.x-dev, 5.2.x-dev].
- caffeinated/menus v2.3 requires laravelcollective/html 5.1.*|5.2.* -> satisfiable by laravelcollective/html[5.1.x-dev, 5.2.x-dev].
- Can only install one of: laravelcollective/html[dev-master, 5.1.x-dev].
- Can only install one of: laravelcollective/html[dev-master, 5.2.x-dev].
- Installation request for laravelcollective/html dev-master -> satisfiable by laravelcollective/html[dev-master].
- Installation request for caffeinated/menus ^2.3 -> satisfiable by caffeinated/menus[v2.3].
composer require caffeinated/menus illuminate/html laravelcollective/html
"caffeinated/menus": "^2.3",
"illuminate/html": "^5.0",
...
"bosnadev/repositories": "^0.9.0",
"doctrine/dbal": "^2.5",
"php-soft/laravel-shopping-cart": "^1.0@dev",
"laravelcollective/html": "5.2.*-dev",
"caffeinated/menus": "^2.3"
"illuminate/html": "^5.0",
